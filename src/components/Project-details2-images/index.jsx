        ...
        <div className="justified-gallery">
          <div className="row">
            <div className="col-md-3 pr-0">
              ...
              <a href="img/portfolio/project2/Kabcorner.jpg">
            ...
            <div className="col-md-3 pr-0">
              ...
              <a>
                <img alt="Project Image 1" src="/img/portfolio/project2/cookie.png" />
              </a>
            </div>
            <div className="col-md-3 pr-0">
              <a>
                <img alt="Project Image 4" src="/img/portfolio/project2/fam.jpg" />
              </a>
            </div>
            <div className="col-md-3 pr-0">
